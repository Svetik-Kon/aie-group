...
- вызывать 'POST /quality-flags-from-csv' – полный набор флагов качества по CSV 
---
...
5. POST /quality-flags-from-csv – полный набор флагов качества по CSV (HW04 2.3.2)

Эндпоинт принимает CSV-файл и возвращает только словарь булевых флагов качества, включая дополнительные флаги из HW03.
...
Состав ключей в flags зависит от того, какие эвристики реализованы в compute_quality_flags (включая HW03).
